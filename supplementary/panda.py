 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "### This is a basic introduction to Pandas library\n",
    "#### We will read the tabular data, select series, sort, and do other processing on the data\n",
    "\n",
    "**Create Data** - We begin by creating our own data set for analysis. \n",
    "\n",
    "**Get Data** - We will learn how to read in the text file containing the top 250 IMDB movies list\n",
    "\n",
    "**Analyze Data** - We will simply find the most popular popular movies in a specific year.\n",
    "\n",
    "**Present Data** - Through tabular data and a graph, clearly show the end user what is the most popular movie genre and year"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "## Create Data\n",
    "We create a dictionary and use it to create a pandas dataframe"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "imdb = pd.read_table(\"supplementary/data/imdb_1000.csv\")"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "imdb = pd.read_table(\"supplementary/data/imdb_1000.csv\", sep=',')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "imdb.title.sort_values(ascending=False).head()"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "imdb.sort_values(['star_rating', 'duration']).head()"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "is_long = imdb.duration >= 200\n",
    "imdb[is_long]\n",
    "\n",
    "# or equivalently, write it in one line (no need to create the 'is_long' object)\n",
    "imdb[imdb.duration >= 200]"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<matplotlib.axes._subplots.AxesSubplot at 0x11f9f7898>"
      ]
     },
     "execution_count": 39,
     "metadata": {},
   ...
   "outputs": [
    {
     "data": {
      "text/plain": [
       "<matplotlib.axes._subplots.AxesSubplot at 0x11fac9048>"
      ]
     },
     "execution_count": 41,
     "metadata": {},
